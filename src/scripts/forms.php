...
if(!function_exists('dataListColor')) {
    /**
...
if(!function_exists('dataListDate')) {
    /**
...
if(!function_exists('dataListDateTimeLocal')) {
    /**
...
if(!function_exists('dataListTime')) {
    /**
...
if(!function_exists('dataListWeek')) {
    /**
...
if(!function_exists('fileSelector')) {
    /**
...
if(!function_exists('number')) {
    /**
     * Renders an HTML div element that surrounds an input of type number.
     *
     * @param string $label Sets the label for this input.
     * @param string $name Sets the value for the name, for, and id attributes 
     * for this input.
     ...
     * attributes of the surrounding div.  The default value is an empty array.
     * @param array $errors The errors array.  Default value is an empty array.
     * @return string A surrounding div and the input element of type number.
     */
    function number(
        string $label,
        string $name,
...
if(!function_exists('timeSelector')) {
    /**
     * Renders an HTML div element that surrounds an input of type timeSelector.
     *
     * @param string $label Sets the label for this input.
     * @param string $name Sets the value for the name, for, and id attributes 
     * for this input.
